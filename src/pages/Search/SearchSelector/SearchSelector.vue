  ...
  export default {
    ...
    methods: {
      ...
      tradeMarkHandler(trademark) {
        // 父组件中searchParams参数是带给服务器参数  子组件把你点击的品牌信息  需要给父组件传递过去
        // 自定义事件   将 trademark 传给父组件
        this.$emit('trademarkInfo',trademark)
      },
      // 平台售卖属性值的点击事件  attr 包括id和attrName(比如23和运行内存) attrValue 点击的售卖属性值(例如8g)
